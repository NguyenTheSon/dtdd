...
class WelcomeController extends Controller {
    ...
    public function getList(Request $request)
    {
        ...
        return view('user.pages.timkiem', compact('products','name','maloai'));
    }
    ...
    public function tienHanhThanhToan(Request $request) {
        ...
        $receiver = "nguyentheson2711@gmail.com";
        $return_url = "http://localhost:/dtdd/thanh-toan-thanh-cong";
        //Giá của cả giỏ hàng 
        $price = Cart::total();
        //Mã giỏ hàng 
        $order_code = $maHD;
    ...
    public function baoHanh() {
        return view('user.pages.baohanh');
    }

    public function khuyenMai() {
        return view('user.pages.khuyenmai');
    }
