...
<section id="columns">
    <div id="breadcrumb">
        <ol class="breadcrumb container">
            ...
            <li><a href="#"><span>{!!$idcate!!}</span></a></li>
        </ol>
    </div>
    <div class="container">
        <div class="row"> 
            <aside class="col-md-3">
                <div id="column-left" class="sidebar">
                    ...
                    @include('user.block.product-new')
                </div>
            </aside>
            <section class="col-md-9">
                <div id="content"> 
                    ...
                    <div class="pagination paging clearfix">
                        {!! $products !!}
                        <div class="results">Hiển thị 1 đến {!!$products->count()!!} trong {!!$products->count()!!} ({!!$products->count()!!} Trang)</div>
