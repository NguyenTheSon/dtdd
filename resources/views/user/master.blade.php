...
<html dir="ltr" class="ltr" lang="vi">
    <head>
        ...
        <meta name="description" content="Thế giới Mobile" />
        <link href="image/data/banner/Mobile-Blackberry-icon.png" rel="icon" />
        ...
        <link href="public/javascript/jquery/colorbox/colorbox.css" rel="stylesheet" />
        <link href="public/stylesheet/pavproducttabs.css" rel="stylesheet" />
        <link href="public/stylesheet/pavverticalmenu/style.css" rel="stylesheet" />
        <link href="public/stylesheet/sliderlayer/css/typo.css" rel="stylesheet" />
        <link href="public/stylesheet/pavmegamenu/style.css" rel="stylesheet" />
        <link href="public/stylesheet/pavreassurance.css" rel="stylesheet" />
        ...
        <script type="text/javascript" src="public/javascript/jquery/colorbox/jquery.colorbox-min.js"></script>
        <script type="text/javascript" src="public/javascript/layerslider/jquery.themepunch.plugins.min.js"></script>
        <script type="text/javascript" src="public/javascript/layerslider/jquery.themepunch.revolution.min.js"></script>


    </head>
    <body id="offcanvas-container" class="offcanvas-container layout-fullwidth fs page-common-home ">
